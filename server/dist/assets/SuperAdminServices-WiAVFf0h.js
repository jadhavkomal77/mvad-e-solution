import{b6 as o,r as x,j as e,I as c,w as d,A as u,L as m,x as p}from"./index-DsHjdIkQ.js";function f(){const{data:s,isLoading:n,isError:l}=o(),i=x();if(n)return h();if(l)return g();const t=s?.services||[];return t.length?e.jsxs("section",{id:"services",className:`\r
