...
export default function SuperAdminServices() {
  const { data, isLoading, isError } = useGetSuperServicesPublicQuery();
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mt-4 text-lg">
            Proven IT expertise that helps organizations achieve
            digital excellence and long-term growth.
          </p>
        </div>
          ...
          {services.map((s) => {
            ...
            return (
              ...
              >
                ...
                {/* DESCRIPTION */}
                <p className="text-gray-600 text-center text-sm mt-3 flex-grow">
                  {s.description}
                </p>

                {/* CTA */}
                <button
                  onClick={() => navigate(`/superadminservices/${s._id}`)}
                  className="
